        ...
        <el-container>
            ...
            <el-main v-loading="loading">
                <el-form label-position="top" v-if="configData">
                    <el-row :gutter="20">
                        <el-col :span="12" v-for="(category, categoryName) in configData" :key="categoryName"
...
import { getGlobalConfig, saveGlobalConfig, updateSingleConfig, triggerButtonClickEvent } from '../api';
